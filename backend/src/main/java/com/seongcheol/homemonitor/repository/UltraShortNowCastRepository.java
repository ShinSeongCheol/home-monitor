...
public interface UltraShortNowCastRepository extends JpaRepository<UltraShortNowCastEntity, Long> {
    ...
    @Query("""
        ...
        WHERE
            ad.level1 = :level1
            AND ad.level2 = :level2
            AND usn.baseDate = :baseDate
        """)
    public List<UltraShortNowCastEntity> findTodayUltraShortNowCastByRegionAndBaseDate(@Param("level1") String level1, @Param("level2") String level2, @Param("baseDate") LocalDate baseDate);
}
