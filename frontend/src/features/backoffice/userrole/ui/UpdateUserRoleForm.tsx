...
import {useUpdateUserRoleForm} from "../model/useUpdateUserRoleForm.ts";

type UpdateUserRoleFormProps = {
    fetchUserRoles: () => Promise<void>;
    data: BackOfficeMemberRole|undefined;
    handleClickCancel: () => void;
}

export const UpdateUserRoleForm = ({fetchUserRoles, data, handleClickCancel}: UpdateUserRoleFormProps) => {
    ...
    return (
        <BackOfficeModalLayout title={'사용자 권한 수정'} content={'사용자 권한을 수정합니다.'} cancel={handleClickCancel} children={form} />
    )
}