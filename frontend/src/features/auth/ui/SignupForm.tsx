    ...
    return (
        <form className={'mt-4 flex flex-col gap-2'} onSubmit={handleSubmit}>
            ...
            <div className={'flex flex-col gap-3'}>
                ...
                <input className={'h-4 p-2 border-none rounded-sm bg-gray-300'} type="text" name="nickname" id="nickname" required placeholder='Nickname' onChange={handleChangeNickname}/>
            </div>
            <div className={'flex flex-col gap-3'}>
            ...
            <div className={'flex flex-col gap-3'}>
                ...
                <input className={'h-4 p-2 border-none rounded-sm bg-gray-300'} type="password" name="password_confirm" id="password_confirm" required placeholder='••••••••' onChange={handleChangePasswordConfirm}/>
            </div>
