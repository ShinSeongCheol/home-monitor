...
export const InsertBoardRoleModal = ({isOpen, setIsOpen, fetchData} : insertModalProps) => {
    ...
    const [selectedBoardRoleCodeId, setSelectedBoardRoleCodeId] = useState<string>("");
    const [selectedMemberRoleCodeId, setSelectedMemberRoleCodeId] = useState<string>("");
                            ...
                            <form className={styles.modalForm} onSubmit={onClickSubmit}>
                                <div className={`${styles.formFields}`}>
                                    <div className={styles.formGroup}>
                                        ...
                                        <select name='board' value={selectedBoardId} onChange={(e) => setSelectedBoardId(e.target.value)}>
                                            {boards?.map((value) => {
                                    ...
                                    <div className={styles.formGroup}>
                                        ...
                                        <select name='boardRoleCode' value={selectedBoardRoleCodeId} onChange={(e) => setSelectedBoardRoleCodeId(e.target.value)}>
                                    ...
                                    <div className={styles.formGroup}>
                                        ...
                                        <select name='memberRoleCode' value={selectedMemberRoleCodeId} onChange={(e) => setSelectedMemberRoleCodeId(e.target.value)}>
                                            <option>전체</option>
