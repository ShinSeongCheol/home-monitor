...
export const InsertReactionCodeModal = ({isOpen, setIsOpen, fetchData} : insertModalProps) => {
    if (!isOpen) return;
...
export const EditReactionCodeModal = ({isOpen, setIsOpen, fetchData, data} : editModalProps) => {
    if (!isOpen) return;
...
export const EditUserRoleCodeModal = ({isOpen, setIsOpen, fetchData, data} : editModalProps) => {
    if (!isOpen) return;
